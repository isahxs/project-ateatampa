...
const AlterarSenhaUsuario = () => {
  ...
  const handleAlterarSenha = async (e) => {
    ...
    try {
      await axios.put(
        `${API_URL}/alterarsenhausuario`,
        { senhaAtual, novaSenha },
        { withCredentials: true }
      );

      toast.success("Senha alterada com sucesso!");
      setTimeout(() => navigate("/loginusuario"), 2000);
    } catch (error) {
      console.error(error);
      toast.error(
  ...
  return (
   <div className="alterar-senha-container">
      {/* Formulário */}
      <div className="alterar-senha-form-section">
        <div className="alterar-senha-content">
          <img src={logoPrincipal} alt="Logo Até a Tampa" className="alterar-senha-logo" />
      ...
      {/* Imagem ao lado */}
      <div className="alterar-senha-image-section">
