...
import ValidacaoLoginAdm from '../validacao/ValidacaoLoginAdm';
...
const LoginAdm = () => {
    ...
    const handleLogin = async (e) => {
        ...
        const erroValidacao = ValidacaoLoginAdm({ email, senha });
        if (erroValidacao) {
        ...
        try {
            ...
            setErro(err.resposta?.data?.error || "Erro ao conectar com o servidor");
        } finally {
            setLoading(false);
        }
    };
                    ...
                    <div className="cont-cadastro w-100" style={{ maxWidth: '420px' }}>
                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="d-grid gap-3 mt-4">
                                ...
                                <button
                                    type="submit"
                                    className="btn btn-primario-adm fw-bold"
                                    disabled={loading}
