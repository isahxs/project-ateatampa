...
import ValidacaoCadastroAdm from '../validacao/ValidacaoCadastroAdm';
...
const navigate = useNavigate();
    ...
    setSucesso('');
        ...
        const erroValidacao = ValidacaoCadastroAdm({
            username,
            email,
            senha,
            confirmarSenha
        ...
        try {
            ...
            const res = await axios.post(
                "http://localhost:7006/cadastroadm",
                {
                    nomeadm: username,
                    email,
                    senha
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center py-5">
                <div className="cont-cadastro w-100" style={{ maxWidth: '450px' }}>
                    ...
                    <section className="cont-logo text-center mb-4">
                        ...
                        />
                        <h3 className="fw-bold mt-2" style={{ color: '#161C5C', fontFamily: 'serif' }}>
                            Crie sua conta <br /> Adm
                        </h3>
                    </section>
                    ...
                    <form onSubmit={handleCadastro}>
                        ...
                        <div className="d-grid gap-3 mt-4">
                                <button
                                    type="submit"
                                    className="btn btn-primario-adm py-2 fw-bold"
                                    style={{ backgroundColor: '#161C5C', fontFamily: 'Story Script' }}
                                    disabled={loading}
                                >
